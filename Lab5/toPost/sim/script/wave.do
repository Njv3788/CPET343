...
radix define States {
    "4'b0001" "input_a" -color "blue",
    "4'b0010" "input_b" -color "blue",
    "4'b0100" "disp_sum" -color "blue",
    "4'b1000" "disp_diff" -color "blue",
    -default default
}
...
add wave -noupdate -radix Display /top_tb/uut/result_out 
add wave -noupdate -radix States /top_tb/uut/state
add wave -noupdate -radix States /top_tb/uut/state_changer/next_state
